...
calculate.household.incomes <- function(data_table, survey, equivalise){
  ...
  if(survey == "FRS"){
    ...
    data_table[ year == '1415', hh_grossinc_nohb := ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52, HHINC*52)]
    data_table[ year == '1314', hh_grossinc_nohb:= ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52 * (99.98/98.94), HHINC* 52 * (99.98/98.94))]
    data_table[ year == '1213', hh_grossinc_nohb:= ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52 * (99.98/96.70), HHINC*52 * (99.98/96.70))]
    data_table[ year == '1112', hh_grossinc_nohb:= ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52 * (99.98/94.23), HHINC*52* (99.98/94.23))]
    data_table[ year == '1011', hh_grossinc_nohb:= ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52 * (99.98/90.33), HHINC*52* (99.98/90.33))]
    data_table[ year == '0910', hh_grossinc_nohb:= ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52 * (99.98/87.28), HHINC*52* (99.98/87.28))]
    data_table[ year == '0809', hh_grossinc_nohb:= ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52 * (99.98/85.35), HHINC*52* (99.98/85.35))]
    data_table[ year == '0708', hh_grossinc_nohb:= ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52 * (99.98/82.27), HHINC*52* (99.98/82.27))]
    ...
    data_table[ (year == '1415'), hh_gross_ahc := (HHINC - GBHSCOST) * 52]
    #inflate 1314 to 1415 prices
    data_table[ (year == '1314'), hh_gross_ahc:= (HHINC - GBHSCOST) * 52 * (99.98/98.94)]
    #inflate 1213 to 1415 prices
    data_table[ (year == '1213'), hh_gross_ahc:= (HHINC - GBHSCOST) * 52 * (99.98/96.70)]
    data_table[ (year == '1112'), hh_gross_ahc:= (HHINC - GBHSCOST) * 52 * (99.98/94.23)]
    data_table[ (year == '1011'), hh_gross_ahc:= (HHINC - GBHSCOST) * 52 * (99.98/90.33)]
    data_table[ (year == '0910'), hh_gross_ahc:= (HHINC - GBHSCOST) * 52 * (99.98/87.28)]
    data_table[ (year == '0809'), hh_gross_ahc:= (HHINC - GBHSCOST) * 52 * (99.98/85.35)]
    data_table[ (year == '0708'), hh_gross_ahc:= (HHINC - GBHSCOST) * 52 * (99.98/82.27)]
    
    if(equivalise == TRUE){
      ##Equivalised
      data_table[ year == '1415',hh_grossinc_eq := HHINC * 52 * equiv_weight]
      #inflate 1314 to 1415 prices
      data_table[ year == '1314',hh_grossinc_eq := HHINC * 52 * equiv_weight * (99.98/98.94)]
      data_table[ year == '1213',hh_grossinc_eq := HHINC * 52 * equiv_weight * (99.98/96.70)]
      data_table[ year == '1112',hh_grossinc_eq := HHINC * 52 * equiv_weight * (99.98/94.23)]
      data_table[ year == '1011',hh_grossinc_eq := HHINC * 52 * equiv_weight * (99.98/90.33)]
      data_table[ year == '0910',hh_grossinc_eq := HHINC * 52 * equiv_weight * (99.98/87.28)]
      data_table[ year == '0809',hh_grossinc_eq := HHINC * 52 * equiv_weight * (99.98/85.35)]
      data_table[ year == '0708',hh_grossinc_eq := HHINC * 52 * equiv_weight * (99.98/82.27)]
      ...
      data_table[ year == '1415', hh_grossinc_nohb_eq := ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52 * equiv_weight, HHINC*52 * equiv_weight)]
      data_table[ year == '1314', hh_grossinc_nohb_eq := ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52 * equiv_weight * (99.98/98.94), HHINC* 52 * equiv_weight * (99.98/98.94))]
      data_table[ year == '1213', hh_grossinc_nohb_eq := ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52 * equiv_weight * (99.98/96.70), HHINC*52 * equiv_weight * (99.98/96.70))]
      data_table[ year == '1112', hh_grossinc_nohb_eq := ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52 * equiv_weight * (99.98/94.23), HHINC*52 * equiv_weight * (99.98/94.23))]
      data_table[ year == '1011', hh_grossinc_nohb_eq := ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52 * equiv_weight * (99.98/90.33), HHINC*52 * equiv_weight * (99.98/90.33))]
      data_table[ year == '0910', hh_grossinc_nohb_eq := ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52 * equiv_weight * (99.98/87.28), HHINC*52 * equiv_weight * (99.98/87.28))]
      data_table[ year == '0809', hh_grossinc_nohb_eq := ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52 * equiv_weight * (99.98/85.35), HHINC*52 * equiv_weight * (99.98/85.35))]
      data_table[ year == '0708', hh_grossinc_nohb_eq := ifelse(!is.na(hh_hbweekly), (HHINC - hh_hbweekly) * 52 * equiv_weight * (99.98/82.27), HHINC*52 * equiv_weight * (99.98/82.27))]
      
      ## gross household income minus income related benefits (including HB) - most relevant when thinking about ownership products
      data_table[ (year == '1415'), hh_grossinc_noincben_eq := (HHINC - HHIRBEN) * 52 * equiv_weight]
      #inflate 1314 to 1415 prices
      data_table[ (year == '1314'), hh_grossinc_noincben_eq:= (HHINC - HHIRBEN) * 52 * equiv_weight * (99.98/98.94)]
      data_table[ (year == '1213'), hh_grossinc_noincben_eq:= (HHINC - HHIRBEN) * 52 * equiv_weight * (99.98/96.70)]
      data_table[ (year == '1112'), hh_grossinc_noincben_eq:= (HHINC - HHIRBEN) * 52 * equiv_weight * (99.98/94.23)]
      data_table[ (year == '1011'), hh_grossinc_noincben_eq:= (HHINC - HHIRBEN) * 52 * equiv_weight * (99.98/90.33)]
      data_table[ (year == '0910'), hh_grossinc_noincben_eq:= (HHINC - HHIRBEN) * 52 * equiv_weight * (99.98/87.28)]
      data_table[ (year == '0809'), hh_grossinc_noincben_eq:= (HHINC - HHIRBEN) * 52 * equiv_weight * (99.98/85.35)]
      data_table[ (year == '0708'), hh_grossinc_noincben_eq:= (HHINC - HHIRBEN) * 52 * equiv_weight * (99.98/82.27)]
      
      ## gross employment income for the household
      data_table[ (year == '1415'), hh_grossinc_earn_eq := (HEARNS) * 52 * equiv_weight]
      #inflate 1314 to 1415 prices
      data_table[ (year == '1314'), hh_grossinc_earn_eq:= (HEARNS) * 52 * equiv_weight * (99.98/98.94)]
      data_table[ (year == '1213'), hh_grossinc_earn_eq:= (HEARNS) * 52 * equiv_weight * (99.98/96.70)]
      data_table[ (year == '1112'), hh_grossinc_earn_eq:= (HEARNS) * 52 * equiv_weight * (99.98/94.23)]
      data_table[ (year == '1011'), hh_grossinc_earn_eq:= (HEARNS) * 52 * equiv_weight * (99.98/90.33)]
      data_table[ (year == '0910'), hh_grossinc_earn_eq:= (HEARNS) * 52 * equiv_weight * (99.98/87.28)]
      data_table[ (year == '0809'), hh_grossinc_earn_eq:= (HEARNS) * 52 * equiv_weight * (99.98/85.35)]
      data_table[ (year == '0708'), hh_grossinc_earn_eq:= (HEARNS) * 52 * equiv_weight * (99.98/82.27)]
      
      # After housing costs income for the household
      data_table[ (year == '1415'), hh_gross_ahc_eq := (HHINC - GBHSCOST) * 52 * equiv_weight]
      data_table[ (year == '1314'), hh_gross_ahc_eq:= (HHINC - GBHSCOST) * 52 * equiv_weight * (99.98/98.94)]
      data_table[ (year == '1213'), hh_gross_ahc_eq:= (HHINC - GBHSCOST) * 52 * equiv_weight * (99.98/96.70)]
      data_table[ (year == '1112'), hh_gross_ahc_eq:= (HHINC - GBHSCOST) * 52 * equiv_weight * (99.98/94.23)]
      data_table[ (year == '1011'), hh_gross_ahc_eq:= (HHINC - GBHSCOST) * 52 * equiv_weight * (99.98/90.33)]
      data_table[ (year == '0910'), hh_gross_ahc_eq:= (HHINC - GBHSCOST) * 52 * equiv_weight * (99.98/87.28)]
      data_table[ (year == '0809'), hh_gross_ahc_eq:= (HHINC - GBHSCOST) * 52 * equiv_weight * (99.98/85.35)]
      data_table[ (year == '0708'), hh_gross_ahc_eq:= (HHINC - GBHSCOST) * 52 * equiv_weight * (99.98/82.27)]
    }
